...
\usepackage{fancyhdr}
\usepackage{setspace}
%\usepackage{indentfirst} % każda sekcja rozpoczyna się od akapitu
\usepackage{emptypage} % strony bez tekstu są zupełnie puste
\usepackage{graphicx}
...
\setlength{\parindent}{1.5cm} %wcięcie akapitu
